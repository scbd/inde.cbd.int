...
define(['app', 'lodash', 'text!views/index.html', 'views/index', 'scbd-angularjs-services/extended-route',  'scbd-angularjs-services/authentication'], function(app, _, rootTemplate) { 'use strict';
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider.
            ...
            when('/manage/users',               { templateUrl: 'views/manage/users.html',                resolveController: true, resolveUser: true }).
            ...
            when('/manage',               { templateUrl: 'views/manage/dash-board.html',        resolveController: true, resolveUser: true,resolve : { securized : securize() }}).
